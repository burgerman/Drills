...
public class HybridSort {
    ...
    private static void BubbleSort(int[] arr) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            // Early stopping if array was already sorted
            if (swapped == false)
                break;
        }
    }
...
//        String path = "/Users/wilfried/IdeaProjects/Drills/src/main/resources/input_data.txt";
//        generateRandomInteger(path);
        String filePath = "input_data.txt";
        File dictFile = new File(JumbleWord.class.getClassLoader().getResource(filePath).getFile());
        if(dictFile.exists()) {
            try(BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(
                    JumbleWord.class.getClassLoader().getResourceAsStream(filePath), StandardCharsets.UTF_8))) {
                ...
                Integer [] arr4 = new Integer[lineNum];
                int index=0;
                String word;
                int tmpInt;
                ...
                String outputFile1 = "/Users/wilfried/IdeaProjects/Drills/src/main/resources/bubble_sort.txt";
                ...
                String outputFile2 = "/Users/wilfried/IdeaProjects/Drills/src/main/resources/merge_sort.txt";
...
//                System.out.println("median: " + select(arr3, 0, arr.length-1));
                ...
                String outputFile3 = "/Users/wilfried/IdeaProjects/Drills/src/main/resources/hybrid_sort.txt";
                doWrite(outputFile3, Arrays.stream(arr3).boxed().collect(Collectors.toList()));
                startTime = System.nanoTime();
                Arrays.sort(arr4, 0, arr4.length-1, Comparator.naturalOrder());
                endTime = System.nanoTime();
                System.out.println("TimSort Time Cost: " + TimeUnit.MILLISECONDS.convert(endTime - startTime, TimeUnit.NANOSECONDS)+ " milliseconds");
